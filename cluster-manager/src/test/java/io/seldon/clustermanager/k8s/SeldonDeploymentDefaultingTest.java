...
public class SeldonDeploymentDefaultingTest extends AppTest {
    ...
    public void testDefaulting() throws IOException
    {
        ...
        Assert.assertEquals("Incorrect number of environment variables in container",3,mlDep2.getSpec().getPredictors(0).getComponentSpec().getSpec().getContainers(0).getEnvCount());
