...
public class KubernetesManagerImpl implements KubernetesManager {
    ...
    private static class KubernetesDeploymentOps {
    ...
    public void createSeldonDeployment(DeploymentDef deploymentDef) {
        ...
        for (PredictiveUnitDef predictiveUnitDef : predictiveUnits) {
            ...
            Deployment deployment = new KubernetesDeploymentOps(seldonDeploymentId, kubernetesClient, namespace_name).create(kubernetesDeploymentId, clusterResourcesDef);
