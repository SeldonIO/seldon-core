...
#ifndef PROTOBUF_tensorflow_2ftensorflow_2fcore_2fframework_2ftypes_2eproto__INCLUDED
#define PROTOBUF_tensorflow_2ftensorflow_2fcore_2fframework_2ftypes_2eproto__INCLUDED
...
enum SpecializedType {
  ST_INVALID = 0,
  ST_TENSOR_LIST = 1,
  SpecializedType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  SpecializedType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool SpecializedType_IsValid(int value);
const SpecializedType SpecializedType_MIN = ST_INVALID;
const SpecializedType SpecializedType_MAX = ST_TENSOR_LIST;
const int SpecializedType_ARRAYSIZE = SpecializedType_MAX + 1;

const ::google::protobuf::EnumDescriptor* SpecializedType_descriptor();
inline const ::std::string& SpecializedType_Name(SpecializedType value) {
  return ::google::protobuf::internal::NameOfEnum(
    SpecializedType_descriptor(), value);
}
inline bool SpecializedType_Parse(
    const ::std::string& name, SpecializedType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<SpecializedType>(
...
template <> struct is_proto_enum< ::tensorflow::SpecializedType> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_tensorflow_2ftensorflow_2fcore_2fframework_2ftypes_2eproto__INCLUDED
