...
class SeldonMetrics:
    ...
    def update(self, custom_metrics):
        ...
        for metrics in custom_metrics:
            ...
            # TODO: Potentiall make tags uniqueness configurable
            # Tags is required as there is uniqueness of metric based on tag
            key = metrics_type, metrics["key"], self._generate_tags_key(tags)
    ...
    def _generate_tags_key(self, tags):
