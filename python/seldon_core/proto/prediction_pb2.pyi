...
class SeldonMessageMeta(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> SeldonMessageMeta: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SeldonMessageMeta: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class TensorMetadata(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> TensorMetadata: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> TensorMetadata: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class SeldonModelMetadata(google___protobuf___message___Message):
    ...
    @property
    def input(self) -> global___SeldonMessageMeta: ...

    @property
    def output(self) -> global___SeldonMessageMeta: ...

    @property
    def inputs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___TensorMetadata]: ...

    @property
    def outputs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___TensorMetadata]: ...
    ...
    def __init__(self,
        *,
        ...
        input : typing___Optional[global___SeldonMessageMeta] = None,
        output : typing___Optional[global___SeldonMessageMeta] = None,
        inputs : typing___Optional[typing___Iterable[global___TensorMetadata]] = None,
        outputs : typing___Optional[typing___Iterable[global___TensorMetadata]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
...
class SeldonGraphMetadata(google___protobuf___message___Message):
    ...
    @property
    def value_inputs(self) -> google___protobuf___struct_pb2___Value: ...

    @property
    def value_outputs(self) -> google___protobuf___struct_pb2___Value: ...
    ...
    def __init__(self,
        *,
        ...
        value_inputs : typing___Optional[google___protobuf___struct_pb2___Value] = None,
        value_outputs : typing___Optional[google___protobuf___struct_pb2___Value] = None,
        input : typing___Optional[global___SeldonMessageMeta] = None,
        output : typing___Optional[global___SeldonMessageMeta] = None,
        inputs : typing___Optional[typing___Iterable[global___TensorMetadata]] = None,
        outputs : typing___Optional[typing___Iterable[global___TensorMetadata]] = None,
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"input",b"input",u"output",b"output",u"value_inputs",b"value_inputs",u"value_outputs",b"value_outputs"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"input",b"input",u"inputs",b"inputs",u"models",b"models",u"name",b"name",u"output",b"output",u"outputs",b"outputs",u"value_inputs",b"value_inputs",u"value_outputs",b"value_outputs"]) -> None: ...
