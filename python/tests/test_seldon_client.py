...
def mock_get_token(oauth_key: str = "", oauth_secret: str = "", namespace: str = None,
...
@mock.patch('seldon_core.seldon_client.microservice_api_rest_aggregate', return_value=SeldonClientCombine(None, None))
...
@mock.patch('seldon_core.seldon_client.microservice_api_rest_feedback', return_value=SeldonClientCombine(None, None))
def test_wiring_microservice_api_rest_feedback(mock_handler):
    sc = SeldonClient()
    response = sc.microservice_feedback(prediction_pb2.SeldonMessage(), prediction_pb2.SeldonMessage(), 1.0,
                                        transport="rest")
    assert mock_handler.call_count == 1
...
@mock.patch('seldon_core.seldon_client.microservice_api_grpc_aggregate', return_value=SeldonClientCombine(None, None))
...
@mock.patch('seldon_core.seldon_client.microservice_api_grpc_feedback', return_value=SeldonClientCombine(None, None))
...
@mock.patch('seldon_core.seldon_client.rest_predict_seldon_oauth', return_value=SeldonClientPrediction(None, None))
...
@mock.patch('seldon_core.seldon_client.grpc_predict_seldon_oauth', return_value=SeldonClientPrediction(None, None))
