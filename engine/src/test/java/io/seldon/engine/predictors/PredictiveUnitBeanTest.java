...
public class PredictiveUnitBeanTest {
	...
	public void testMergeMetaList() throws InvalidProtocolBufferException, NoSuchMethodException, IllegalAccessException, InvocationTargetException
	{
        ...
        Method method = PredictiveUnitBean.class.getDeclaredMethod("mergeMeta", SeldonMessage.class, List.class);
		...
		Value v2 = Value.newBuilder().setNumberValue(2.0).build();
		...
		Value v3 = Value.newBuilder().setNumberValue(3.0).build();
        ...
        SeldonMessage r1 = (SeldonMessage) method.invoke(pu, s1, messages);
        ...
        SeldonMessage r2 = (SeldonMessage) method.invoke(pu, s1, messages);
