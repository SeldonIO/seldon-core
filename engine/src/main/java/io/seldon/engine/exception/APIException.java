...
public class APIException extends RuntimeException {
	...
	public enum ApiExceptionType { 
		...
		APIFE_INVALID_JSON(201,"Invalid JSON",500),
		APIFE_INVALID_ENDPOINT_URL(202,"Invalid Endpoint URL",500),	
		APIFE_MICROSERVICE_ERROR(203,"Microservice error",500),
		APIFE_INVALID_ABTEST(204,"No Running Deployment",500),
		APIFE_INVALID_COMBINER_RESPONSE(204,"Invalid number of predictions from combiner",500);
