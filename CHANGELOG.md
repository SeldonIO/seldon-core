...
Core 2.9.1 is a patch release focused on bugfixes and security. Despite this focus, we also introduce a number of important features, described below:
...
* Core 2 images published on docker hub now have embedded SBOM attestations. At the moment of the release, security scans show zero CVEs within those images.
