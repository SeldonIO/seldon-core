...
type ReplicaConfig struct {
	...
	OverCommitPercentage uint32   `protobuf:"varint,6,opt,name=overCommitPercentage,proto3" json:"overCommitPercentage,omitempty"` // The percentage of over commit to allow, set to 100 to disable over commit
}
