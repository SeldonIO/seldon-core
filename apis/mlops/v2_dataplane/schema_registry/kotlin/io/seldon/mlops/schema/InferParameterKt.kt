...
public inline fun inferParameter(block: io.seldon.mlops.schema.InferParameterKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.schema.InferenceSchema.InferParameter =
  io.seldon.mlops.schema.InferParameterKt.Dsl._create(io.seldon.mlops.schema.InferenceSchema.InferParameter.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `seldon.mlops.inference.schema.InferParameter`
 */
public object InferParameterKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.seldon.mlops.schema.InferenceSchema.InferParameter.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.seldon.mlops.schema.InferenceSchema.InferParameter.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.seldon.mlops.schema.InferenceSchema.InferParameter = _builder.build()
    ...
    public val parameterChoiceCase: io.seldon.mlops.schema.InferenceSchema.InferParameter.ParameterChoiceCase
...
@kotlin.jvm.JvmSynthetic
public inline fun io.seldon.mlops.schema.InferenceSchema.InferParameter.copy(block: `io.seldon.mlops.schema`.InferParameterKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.schema.InferenceSchema.InferParameter =
  `io.seldon.mlops.schema`.InferParameterKt.Dsl._create(this.toBuilder()).apply { block() }._build()
