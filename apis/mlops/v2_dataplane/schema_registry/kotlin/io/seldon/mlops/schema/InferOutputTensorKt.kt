...
public inline fun inferOutputTensor(block: io.seldon.mlops.schema.InferOutputTensorKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.schema.InferenceSchema.InferOutputTensor =
  io.seldon.mlops.schema.InferOutputTensorKt.Dsl._create(io.seldon.mlops.schema.InferenceSchema.InferOutputTensor.newBuilder()).apply { block() }._build()
/**
 * ```
 * An output tensor returned for an inference request.
 * ```
 *
 * Protobuf type `seldon.mlops.inference.schema.InferOutputTensor`
 */
public object InferOutputTensorKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.seldon.mlops.schema.InferenceSchema.InferOutputTensor.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.seldon.mlops.schema.InferenceSchema.InferOutputTensor.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.seldon.mlops.schema.InferenceSchema.InferOutputTensor = _builder.build()
    ...
    public val InferOutputTensorKt.Dsl.contentsOrNull: io.seldon.mlops.schema.InferenceSchema.InferTensorContents?
      get() = _builder.contentsOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun io.seldon.mlops.schema.InferenceSchema.InferOutputTensor.copy(block: `io.seldon.mlops.schema`.InferOutputTensorKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.schema.InferenceSchema.InferOutputTensor =
  `io.seldon.mlops.schema`.InferOutputTensorKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val io.seldon.mlops.schema.InferenceSchema.InferOutputTensorOrBuilder.contentsOrNull: io.seldon.mlops.schema.InferenceSchema.InferTensorContents?
