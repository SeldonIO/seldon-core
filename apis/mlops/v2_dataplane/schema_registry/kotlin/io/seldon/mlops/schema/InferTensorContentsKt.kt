...
public inline fun inferTensorContents(block: io.seldon.mlops.schema.InferTensorContentsKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.schema.InferenceSchema.InferTensorContents =
  io.seldon.mlops.schema.InferTensorContentsKt.Dsl._create(io.seldon.mlops.schema.InferenceSchema.InferTensorContents.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `seldon.mlops.inference.schema.InferTensorContents`
 */
public object InferTensorContentsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.seldon.mlops.schema.InferenceSchema.InferTensorContents.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.seldon.mlops.schema.InferenceSchema.InferTensorContents.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.seldon.mlops.schema.InferenceSchema.InferTensorContents = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun io.seldon.mlops.schema.InferenceSchema.InferTensorContents.copy(block: `io.seldon.mlops.schema`.InferTensorContentsKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.schema.InferenceSchema.InferTensorContents =
  `io.seldon.mlops.schema`.InferTensorContentsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
