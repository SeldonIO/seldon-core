...
@kotlin.jvm.JvmName("-initializerepositoryModelLoadRequest")
public inline fun repositoryModelLoadRequest(block: io.seldon.mlops.inference.v2.RepositoryModelLoadRequestKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.inference.v2.V2Dataplane.RepositoryModelLoadRequest =
  io.seldon.mlops.inference.v2.RepositoryModelLoadRequestKt.Dsl._create(io.seldon.mlops.inference.v2.V2Dataplane.RepositoryModelLoadRequest.newBuilder()).apply { block() }._build()
public object RepositoryModelLoadRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.seldon.mlops.inference.v2.V2Dataplane.RepositoryModelLoadRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.seldon.mlops.inference.v2.V2Dataplane.RepositoryModelLoadRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.seldon.mlops.inference.v2.V2Dataplane.RepositoryModelLoadRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun io.seldon.mlops.inference.v2.V2Dataplane.RepositoryModelLoadRequest.copy(block: io.seldon.mlops.inference.v2.RepositoryModelLoadRequestKt.Dsl.() -> kotlin.Unit): io.seldon.mlops.inference.v2.V2Dataplane.RepositoryModelLoadRequest =
  io.seldon.mlops.inference.v2.RepositoryModelLoadRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
