...
var file_mlops_proxy_proxy_proto_goTypes = []any{
...
func file_mlops_proxy_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mlops_proxy_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mlops_proxy_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mlops_proxy_proxy_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_mlops_proxy_proxy_proto_msgTypes[3].Exporter = func(v any, i int) any {
