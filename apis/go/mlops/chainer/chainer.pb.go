...
type PipelineTopic struct {
	...
	Tensor       bool   `protobuf:"varint,3,opt,name=tensor,proto3" json:"tensor,omitempty"`
}
...
func (x *PipelineTopic) GetTensor() bool {
	if x != nil {
		return x.Tensor
	}
	return false
...
var file_mlops_chainer_chainer_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0x69, 0x0a, 0x0d, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x54,
	...
	0x69, 0x63, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x22, 0x71,
