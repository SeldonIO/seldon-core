...
const (
	Chainer_SubscribePipelineUpdates_FullMethodName = "/seldon.mlops.chainer.Chainer/SubscribePipelineUpdates"
	Chainer_PipelineUpdateEvent_FullMethodName      = "/seldon.mlops.chainer.Chainer/PipelineUpdateEvent"
)
...
func (c *chainerClient) SubscribePipelineUpdates(ctx context.Context, in *PipelineSubscriptionRequest, opts ...grpc.CallOption) (Chainer_SubscribePipelineUpdatesClient, error) {
	...
	stream, err := c.cc.NewStream(ctx, &Chainer_ServiceDesc.Streams[0], Chainer_SubscribePipelineUpdates_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &chainerSubscribePipelineUpdatesClient{ClientStream: stream}
...
func (c *chainerClient) PipelineUpdateEvent(ctx context.Context, in *PipelineUpdateStatusMessage, opts ...grpc.CallOption) (*PipelineUpdateStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, Chainer_PipelineUpdateEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Chainer_SubscribePipelineUpdates_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChainerServer).SubscribePipelineUpdates(m, &chainerSubscribePipelineUpdatesServer{ServerStream: stream})
}
...
func _Chainer_PipelineUpdateEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chainer_PipelineUpdateEvent_FullMethodName,
	}
