...
const (
	AgentService_AgentEvent_FullMethodName          = "/seldon.mlops.agent.AgentService/AgentEvent"
	AgentService_Subscribe_FullMethodName           = "/seldon.mlops.agent.AgentService/Subscribe"
	AgentService_ModelScalingTrigger_FullMethodName = "/seldon.mlops.agent.AgentService/ModelScalingTrigger"
	AgentService_AgentDrain_FullMethodName          = "/seldon.mlops.agent.AgentService/AgentDrain"
	AgentService_HealthCheck_FullMethodName         = "/seldon.mlops.agent.AgentService/HealthCheck"
)
...
func (c *agentServiceClient) AgentEvent(ctx context.Context, in *ModelEventMessage, opts ...grpc.CallOption) (*ModelEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentService_AgentEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) Subscribe(ctx context.Context, in *AgentSubscribeRequest, opts ...grpc.CallOption) (AgentService_SubscribeClient, error) {
	...
	x := &agentServiceSubscribeClient{ClientStream: stream}
...
func (c *agentServiceClient) ModelScalingTrigger(ctx context.Context, opts ...grpc.CallOption) (AgentService_ModelScalingTriggerClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AgentService_ServiceDesc.Streams[1], AgentService_ModelScalingTrigger_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &agentServiceModelScalingTriggerClient{ClientStream: stream}
	return x, nil
}
...
func (c *agentServiceClient) AgentDrain(ctx context.Context, in *AgentDrainRequest, opts ...grpc.CallOption) (*AgentDrainResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentService_AgentDrain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentService_AgentEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_AgentEvent_FullMethodName,
	}
...
func _AgentService_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AgentServiceServer).Subscribe(m, &agentServiceSubscribeServer{ServerStream: stream})
}
...
func _AgentService_ModelScalingTrigger_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AgentServiceServer).ModelScalingTrigger(&agentServiceModelScalingTriggerServer{ServerStream: stream})
}
...
func _AgentService_AgentDrain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_AgentDrain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
