...
type ModelConfig_Type int32

const (
	ModelConfig_UNKNOWN_TYPE ModelConfig_Type = 0
	ModelConfig_MLSERVER     ModelConfig_Type = 1
	ModelConfig_TRITON       ModelConfig_Type = 2
)

// Enum value maps for ModelConfig_Type.
var (
	ModelConfig_Type_name = map[int32]string{
		0: "UNKNOWN_TYPE",
		1: "MLSERVER",
		2: "TRITON",
	}
	ModelConfig_Type_value = map[string]int32{
		"UNKNOWN_TYPE": 0,
		"MLSERVER":     1,
		"TRITON":       2,
	}
...
func (x ModelConfig_Type) Enum() *ModelConfig_Type {
	p := new(ModelConfig_Type)
	*p = x
	return p
}

func (x ModelConfig_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ModelConfig_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_mlops_agent_agent_proto_enumTypes[1].Descriptor()
}

func (ModelConfig_Type) Type() protoreflect.EnumType {
	return &file_mlops_agent_agent_proto_enumTypes[1]
}

func (x ModelConfig_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ModelConfig_Type.Descriptor instead.
func (ModelConfig_Type) EnumDescriptor() ([]byte, []int) {
	return file_mlops_agent_agent_proto_rawDescGZIP(), []int{1, 0}
}
...
func (ModelOperationMessage_Operation) Descriptor() protoreflect.EnumDescriptor {
	return file_mlops_agent_agent_proto_enumTypes[3].Descriptor()
}

func (ModelOperationMessage_Operation) Type() protoreflect.EnumType {
	return &file_mlops_agent_agent_proto_enumTypes[3]
}
...
func (ModelOperationMessage_Operation) EnumDescriptor() ([]byte, []int) {
	return file_mlops_agent_agent_proto_rawDescGZIP(), []int{12, 0}
}
...
type ModelEventMessage struct {
	...
	ModelConfig          *ModelConfig            `protobuf:"bytes,8,opt,name=modelConfig,proto3" json:"modelConfig,omitempty"`
}
...
func (x *ModelEventMessage) GetModelConfig() *ModelConfig {
	if x != nil {
...
type ModelConfig struct {
	...
	Type ModelConfig_Type `protobuf:"varint,1,opt,name=type,proto3,enum=seldon.mlops.agent.ModelConfig_Type" json:"type,omitempty"`
	// Types that are assignable to Config:
	//
	//	*ModelConfig_Mlserver
	//	*ModelConfig_Triton
	Config isModelConfig_Config `protobuf_oneof:"config"`
}
...
func (x *ModelConfig) GetType() ModelConfig_Type {
	if x != nil {
		return x.Type
	}
	return ModelConfig_UNKNOWN_TYPE
}

func (m *ModelConfig) GetConfig() isModelConfig_Config {
	if m != nil {
		return m.Config
	}
	return nil
...
func (x *ModelConfig) GetMlserver() *MLServerModelConfig {
	if x, ok := x.GetConfig().(*ModelConfig_Mlserver); ok {
		return x.Mlserver
	}
	return nil
}

func (x *ModelConfig) GetTriton() *TritonModelConfig {
	if x, ok := x.GetConfig().(*ModelConfig_Triton); ok {
		return x.Triton
	}
	return nil
}

type isModelConfig_Config interface {
	isModelConfig_Config()
}

type ModelConfig_Mlserver struct {
	Mlserver *MLServerModelConfig `protobuf:"bytes,2,opt,name=mlserver,proto3,oneof"`
}

type ModelConfig_Triton struct {
	Triton *TritonModelConfig `protobuf:"bytes,3,opt,name=triton,proto3,oneof"`
}

func (*ModelConfig_Mlserver) isModelConfig_Config() {}

func (*ModelConfig_Triton) isModelConfig_Config() {}

type MLServerModelConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MLServerModelConfig) Reset() {
	*x = MLServerModelConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *MLServerModelConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MLServerModelConfig) ProtoMessage() {}

func (x *MLServerModelConfig) ProtoReflect() protoreflect.Message {
	mi := &file_mlops_agent_agent_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MLServerModelConfig.ProtoReflect.Descriptor instead.
func (*MLServerModelConfig) Descriptor() ([]byte, []int) {
	return file_mlops_agent_agent_proto_rawDescGZIP(), []int{2}
}

func (x *MLServerModelConfig) GetInstanceCount() uint32 {
	if x != nil {
...
type TritonModelConfig struct {
	...
	Cpu *TritonCPU `protobuf:"bytes,1,opt,name=cpu,proto3" json:"cpu,omitempty"`
}
...
func (x *ModelVersion) GetModelConfig() *ModelConfig {
	if x != nil {
		return x.ModelConfig
	}
	return nil
...
var file_mlops_agent_agent_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x85,
	...
	,
	...
	0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x78, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64,
	0x78, 0x12, 0x1c, 0x0a, 0x09, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	...
	,
	...
	0x22, 0x27, 0x0a, 0x07, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x0c, 0x0a, 0x08, 0x53,
	0x43, 0x41, 0x4c, 0x45, 0x5f, 0x55, 0x50, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x53, 0x43, 0x41,
	0x4c, 0x45, 0x5f, 0x44, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x22, 0x1d, 0x0a, 0x1b, 0x4d, 0x6f, 0x64,
	0x65, 0x6c, 0x53, 0x63, 0x61, 0x6c, 0x69, 0x6e, 0x67, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x53, 0x0a, 0x11, 0x41, 0x67, 0x65, 0x6e,
	0x74, 0x44, 0x72, 0x61, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1e, 0x0a,
	...
	0x0a, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x78, 0x22, 0x2e, 0x0a,
	0x12, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x44, 0x72, 0x61, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0xb2, 0x02,
	0x0a, 0x15, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65,
	...
	,
	...
	0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12, 0x32, 0x0a, 0x14, 0x6f, 0x76,
	0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61,
	0x67, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x14, 0x6f, 0x76, 0x65, 0x72, 0x43, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x22, 0xa2,
	0x02, 0x0a, 0x15, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x52, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x44, 0x0a, 0x0c, 0x6d,
	...
	,
	...
	0x65, 0x6c, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x12, 0x41, 0x0a, 0x0b, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x73, 0x65, 0x6c, 0x64, 0x6f,
	...
	,
	...
	0x2f, 0x67, 0x6f, 0x2f, 0x76, 0x32, 0x2f, 0x6d, 0x6c, 0x6f, 0x70, 0x73, 0x2f, 0x61, 0x67, 0x65,
...
var file_mlops_agent_agent_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_mlops_agent_agent_proto_goTypes = []any{
	...
	(ModelConfig_Type)(0),                   // 1: seldon.mlops.agent.ModelConfig.Type
	(ModelScalingTriggerMessage_Trigger)(0), // 2: seldon.mlops.agent.ModelScalingTriggerMessage.Trigger
	(ModelOperationMessage_Operation)(0),    // 3: seldon.mlops.agent.ModelOperationMessage.Operation
	(*ModelEventMessage)(nil),               // 4: seldon.mlops.agent.ModelEventMessage
	(*ModelConfig)(nil),                     // 5: seldon.mlops.agent.ModelConfig
	(*MLServerModelConfig)(nil),             // 6: seldon.mlops.agent.MLServerModelConfig
	(*TritonModelConfig)(nil),               // 7: seldon.mlops.agent.TritonModelConfig
	(*TritonCPU)(nil),                       // 8: seldon.mlops.agent.TritonCPU
	(*ModelEventResponse)(nil),              // 9: seldon.mlops.agent.ModelEventResponse
	(*ModelScalingTriggerMessage)(nil),      // 10: seldon.mlops.agent.ModelScalingTriggerMessage
	(*ModelScalingTriggerResponse)(nil),     // 11: seldon.mlops.agent.ModelScalingTriggerResponse
	(*AgentDrainRequest)(nil),               // 12: seldon.mlops.agent.AgentDrainRequest
	(*AgentDrainResponse)(nil),              // 13: seldon.mlops.agent.AgentDrainResponse
	(*AgentSubscribeRequest)(nil),           // 14: seldon.mlops.agent.AgentSubscribeRequest
	(*ReplicaConfig)(nil),                   // 15: seldon.mlops.agent.ReplicaConfig
	(*ModelOperationMessage)(nil),           // 16: seldon.mlops.agent.ModelOperationMessage
	(*ModelVersion)(nil),                    // 17: seldon.mlops.agent.ModelVersion
	nil,                                     // 18: seldon.mlops.agent.ModelScalingTriggerMessage.MetricsEntry
	(*scheduler.Model)(nil),                 // 19: seldon.mlops.scheduler.Model
}
var file_mlops_agent_agent_proto_depIdxs = []int32{
	...
	5,  // 1: seldon.mlops.agent.ModelEventMessage.modelConfig:type_name -> seldon.mlops.agent.ModelConfig
	1,  // 2: seldon.mlops.agent.ModelConfig.type:type_name -> seldon.mlops.agent.ModelConfig.Type
	6,  // 3: seldon.mlops.agent.ModelConfig.mlserver:type_name -> seldon.mlops.agent.MLServerModelConfig
	7,  // 4: seldon.mlops.agent.ModelConfig.triton:type_name -> seldon.mlops.agent.TritonModelConfig
	8,  // 5: seldon.mlops.agent.TritonModelConfig.cpu:type_name -> seldon.mlops.agent.TritonCPU
	2,  // 6: seldon.mlops.agent.ModelScalingTriggerMessage.trigger:type_name -> seldon.mlops.agent.ModelScalingTriggerMessage.Trigger
	18, // 7: seldon.mlops.agent.ModelScalingTriggerMessage.metrics:type_name -> seldon.mlops.agent.ModelScalingTriggerMessage.MetricsEntry
	15, // 8: seldon.mlops.agent.AgentSubscribeRequest.replicaConfig:type_name -> seldon.mlops.agent.ReplicaConfig
	17, // 9: seldon.mlops.agent.AgentSubscribeRequest.loadedModels:type_name -> seldon.mlops.agent.ModelVersion
	3,  // 10: seldon.mlops.agent.ModelOperationMessage.operation:type_name -> seldon.mlops.agent.ModelOperationMessage.Operation
	17, // 11: seldon.mlops.agent.ModelOperationMessage.modelVersion:type_name -> seldon.mlops.agent.ModelVersion
	19, // 12: seldon.mlops.agent.ModelVersion.model:type_name -> seldon.mlops.scheduler.Model
	5,  // 13: seldon.mlops.agent.ModelVersion.modelConfig:type_name -> seldon.mlops.agent.ModelConfig
	4,  // 14: seldon.mlops.agent.AgentService.AgentEvent:input_type -> seldon.mlops.agent.ModelEventMessage
	14, // 15: seldon.mlops.agent.AgentService.Subscribe:input_type -> seldon.mlops.agent.AgentSubscribeRequest
	10, // 16: seldon.mlops.agent.AgentService.ModelScalingTrigger:input_type -> seldon.mlops.agent.ModelScalingTriggerMessage
	12, // 17: seldon.mlops.agent.AgentService.AgentDrain:input_type -> seldon.mlops.agent.AgentDrainRequest
	9,  // 18: seldon.mlops.agent.AgentService.AgentEvent:output_type -> seldon.mlops.agent.ModelEventResponse
	16, // 19: seldon.mlops.agent.AgentService.Subscribe:output_type -> seldon.mlops.agent.ModelOperationMessage
	11, // 20: seldon.mlops.agent.AgentService.ModelScalingTrigger:output_type -> seldon.mlops.agent.ModelScalingTriggerResponse
	13, // 21: seldon.mlops.agent.AgentService.AgentDrain:output_type -> seldon.mlops.agent.AgentDrainResponse
...
func file_mlops_agent_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mlops_agent_agent_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*MLServerModelConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_mlops_agent_agent_proto_msgTypes[1].OneofWrappers = []any{
		(*ModelConfig_Mlserver)(nil),
		(*ModelConfig_Triton)(nil),
	}
	type x struct{}
