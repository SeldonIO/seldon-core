...
type ModelConfig_Resource int32

const (
	ModelConfig_UNKNOWN_RESOURCE ModelConfig_Resource = 0
	ModelConfig_MEMORY           ModelConfig_Resource = 1
	ModelConfig_GPU_MEMORY       ModelConfig_Resource = 2
)

// Enum value maps for ModelConfig_Resource.
var (
	ModelConfig_Resource_name = map[int32]string{
		0: "UNKNOWN_RESOURCE",
		1: "MEMORY",
		2: "GPU_MEMORY",
	}
	ModelConfig_Resource_value = map[string]int32{
		"UNKNOWN_RESOURCE": 0,
		"MEMORY":           1,
		"GPU_MEMORY":       2,
	}
...
func (x ModelConfig_Resource) Enum() *ModelConfig_Resource {
	p := new(ModelConfig_Resource)
	*p = x
	return p
}

func (x ModelConfig_Resource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ModelConfig_Resource) Descriptor() protoreflect.EnumDescriptor {
	return file_mlops_agent_agent_proto_enumTypes[1].Descriptor()
}

func (ModelConfig_Resource) Type() protoreflect.EnumType {
	return &file_mlops_agent_agent_proto_enumTypes[1]
}

func (x ModelConfig_Resource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ModelConfig_Resource.Descriptor instead.
func (ModelConfig_Resource) EnumDescriptor() ([]byte, []int) {
...
func (ModelScalingTriggerMessage_Trigger) EnumDescriptor() ([]byte, []int) {
	return file_mlops_agent_agent_proto_rawDescGZIP(), []int{3, 0}
}
...
func (ModelOperationMessage_Operation) EnumDescriptor() ([]byte, []int) {
	return file_mlops_agent_agent_proto_rawDescGZIP(), []int{9, 0}
}
...
type ModelConfig struct {
	...
	InstanceCount uint32               `protobuf:"varint,1,opt,name=instanceCount,proto3" json:"instanceCount,omitempty"`                                    // The number of instances of the model on a replica
	Resource      ModelConfig_Resource `protobuf:"varint,2,opt,name=resource,proto3,enum=seldon.mlops.agent.ModelConfig_Resource" json:"resource,omitempty"` // The resource consumed
}
...
func (x *ModelConfig) GetInstanceCount() uint32 {
	if x != nil {
...
func (x *ModelConfig) GetResource() ModelConfig_Resource {
	if x != nil {
		return x.Resource
	}
	return ModelConfig_UNKNOWN_RESOURCE
}
...
var file_mlops_agent_agent_proto_rawDesc = []byte{
	...
	,
...
var file_mlops_agent_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_mlops_agent_agent_proto_goTypes = []any{
	(ModelEventMessage_Event)(0),            // 0: seldon.mlops.agent.ModelEventMessage.Event
	(ModelConfig_Resource)(0),               // 1: seldon.mlops.agent.ModelConfig.Resource
	...
	(*ModelEventResponse)(nil),              // 6: seldon.mlops.agent.ModelEventResponse
	(*ModelScalingTriggerMessage)(nil),      // 7: seldon.mlops.agent.ModelScalingTriggerMessage
	(*ModelScalingTriggerResponse)(nil),     // 8: seldon.mlops.agent.ModelScalingTriggerResponse
	(*AgentDrainRequest)(nil),               // 9: seldon.mlops.agent.AgentDrainRequest
	(*AgentDrainResponse)(nil),              // 10: seldon.mlops.agent.AgentDrainResponse
	(*AgentSubscribeRequest)(nil),           // 11: seldon.mlops.agent.AgentSubscribeRequest
	(*ReplicaConfig)(nil),                   // 12: seldon.mlops.agent.ReplicaConfig
	(*ModelOperationMessage)(nil),           // 13: seldon.mlops.agent.ModelOperationMessage
	(*ModelVersion)(nil),                    // 14: seldon.mlops.agent.ModelVersion
	nil,                                     // 15: seldon.mlops.agent.ModelScalingTriggerMessage.MetricsEntry
	(*scheduler.Model)(nil),                 // 16: seldon.mlops.scheduler.Model
}
var file_mlops_agent_agent_proto_depIdxs = []int32{
	...
	1,  // 2: seldon.mlops.agent.ModelConfig.resource:type_name -> seldon.mlops.agent.ModelConfig.Resource
	2,  // 3: seldon.mlops.agent.ModelScalingTriggerMessage.trigger:type_name -> seldon.mlops.agent.ModelScalingTriggerMessage.Trigger
	15, // 4: seldon.mlops.agent.ModelScalingTriggerMessage.metrics:type_name -> seldon.mlops.agent.ModelScalingTriggerMessage.MetricsEntry
	12, // 5: seldon.mlops.agent.AgentSubscribeRequest.replicaConfig:type_name -> seldon.mlops.agent.ReplicaConfig
	14, // 6: seldon.mlops.agent.AgentSubscribeRequest.loadedModels:type_name -> seldon.mlops.agent.ModelVersion
	3,  // 7: seldon.mlops.agent.ModelOperationMessage.operation:type_name -> seldon.mlops.agent.ModelOperationMessage.Operation
	14, // 8: seldon.mlops.agent.ModelOperationMessage.modelVersion:type_name -> seldon.mlops.agent.ModelVersion
	16, // 9: seldon.mlops.agent.ModelVersion.model:type_name -> seldon.mlops.scheduler.Model
	5,  // 10: seldon.mlops.agent.ModelVersion.modelConfig:type_name -> seldon.mlops.agent.ModelConfig
	4,  // 11: seldon.mlops.agent.AgentService.AgentEvent:input_type -> seldon.mlops.agent.ModelEventMessage
	11, // 12: seldon.mlops.agent.AgentService.Subscribe:input_type -> seldon.mlops.agent.AgentSubscribeRequest
	7,  // 13: seldon.mlops.agent.AgentService.ModelScalingTrigger:input_type -> seldon.mlops.agent.ModelScalingTriggerMessage
	9,  // 14: seldon.mlops.agent.AgentService.AgentDrain:input_type -> seldon.mlops.agent.AgentDrainRequest
	6,  // 15: seldon.mlops.agent.AgentService.AgentEvent:output_type -> seldon.mlops.agent.ModelEventResponse
	13, // 16: seldon.mlops.agent.AgentService.Subscribe:output_type -> seldon.mlops.agent.ModelOperationMessage
	8,  // 17: seldon.mlops.agent.AgentService.ModelScalingTrigger:output_type -> seldon.mlops.agent.ModelScalingTriggerResponse
	10, // 18: seldon.mlops.agent.AgentService.AgentDrain:output_type -> seldon.mlops.agent.AgentDrainResponse
