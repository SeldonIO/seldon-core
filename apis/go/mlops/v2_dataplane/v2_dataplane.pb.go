...
var file_mlops_v2_dataplane_v2_dataplane_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x55, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x85, 0x07, 0x0a, 0x14, 0x47, 0x52, 0x50, 0x43,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x55, 0x0a, 0x10, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x53,
	...
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72,
	...
	0x5d, 0x0a, 0x1c, 0x69, 0x6f, 0x2e, 0x73, 0x65, 0x6c, 0x64, 0x6f, 0x6e, 0x2e, 0x6d, 0x6c, 0x6f,
	0x70, 0x73, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x32, 0x5a,
	0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x65, 0x6c, 0x64,
	...
	0x73, 0x2f, 0x76, 0x32, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x62, 0x06,
...
var file_mlops_v2_dataplane_v2_dataplane_proto_depIdxs = []int32{
	...
	10, // 32: inference.GRPCInferenceService.ModelStreamInfer:input_type -> inference.ModelInferRequest
	15, // 33: inference.GRPCInferenceService.RepositoryIndex:input_type -> inference.RepositoryIndexRequest
	17, // 34: inference.GRPCInferenceService.RepositoryModelLoad:input_type -> inference.RepositoryModelLoadRequest
	19, // 35: inference.GRPCInferenceService.RepositoryModelUnload:input_type -> inference.RepositoryModelUnloadRequest
	1,  // 36: inference.GRPCInferenceService.ServerLive:output_type -> inference.ServerLiveResponse
	3,  // 37: inference.GRPCInferenceService.ServerReady:output_type -> inference.ServerReadyResponse
	5,  // 38: inference.GRPCInferenceService.ModelReady:output_type -> inference.ModelReadyResponse
	7,  // 39: inference.GRPCInferenceService.ServerMetadata:output_type -> inference.ServerMetadataResponse
	9,  // 40: inference.GRPCInferenceService.ModelMetadata:output_type -> inference.ModelMetadataResponse
	11, // 41: inference.GRPCInferenceService.ModelInfer:output_type -> inference.ModelInferResponse
	11, // 42: inference.GRPCInferenceService.ModelStreamInfer:output_type -> inference.ModelInferResponse
	16, // 43: inference.GRPCInferenceService.RepositoryIndex:output_type -> inference.RepositoryIndexResponse
	18, // 44: inference.GRPCInferenceService.RepositoryModelLoad:output_type -> inference.RepositoryModelLoadResponse
	20, // 45: inference.GRPCInferenceService.RepositoryModelUnload:output_type -> inference.RepositoryModelUnloadResponse
