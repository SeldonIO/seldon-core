...
type ModelSnapshot struct {
	...
	Versions []*ModelVersionStatus `protobuf:"bytes,1,rep,name=versions,proto3" json:"versions,omitempty"`
	Deleted  bool                  `protobuf:"varint,2,opt,name=deleted,proto3" json:"deleted,omitempty"`
}
...
func (x *ModelSnapshot) Reset() {
	*x = ModelSnapshot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mlops_scheduler_storage_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ModelSnapshot) Descriptor() ([]byte, []int) {
	return file_mlops_scheduler_storage_proto_rawDescGZIP(), []int{2}
}

func (x *ModelSnapshot) GetVersions() []*ModelVersionStatus {
	if x != nil {
		return x.Versions
	}
	return nil
...
func (x *ModelSnapshot) GetDeleted() bool {
	if x != nil {
		return x.Deleted
	}
	return false
...
var file_mlops_scheduler_storage_proto_rawDesc = []byte{
	...
	,
...
var file_mlops_scheduler_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mlops_scheduler_storage_proto_goTypes = []any{
	...
	(*ModelSnapshot)(nil),      // 2: seldon.mlops.scheduler.ModelSnapshot
	(*PipelineWithState)(nil),  // 3: seldon.mlops.scheduler.PipelineWithState
	(*Experiment)(nil),         // 4: seldon.mlops.scheduler.Experiment
	(*ModelVersionStatus)(nil), // 5: seldon.mlops.scheduler.ModelVersionStatus
}
var file_mlops_scheduler_storage_proto_depIdxs = []int32{
	3, // 0: seldon.mlops.scheduler.PipelineSnapshot.versions:type_name -> seldon.mlops.scheduler.PipelineWithState
	4, // 1: seldon.mlops.scheduler.ExperimentSnapshot.experiment:type_name -> seldon.mlops.scheduler.Experiment
	5, // 2: seldon.mlops.scheduler.ModelSnapshot.versions:type_name -> seldon.mlops.scheduler.ModelVersionStatus
...
func file_mlops_scheduler_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mlops_scheduler_storage_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mlops_scheduler_storage_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mlops_scheduler_storage_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ModelSnapshot); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
