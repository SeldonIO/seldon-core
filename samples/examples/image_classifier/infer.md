...
```
2023-03-09 22:21:10.957280: W tensorflow/stream_executor/platform/default/dso_loader.cc:64] Could not load dynamic library 'libcudart.so.11.0'; dlerror: libcudart.so.11.0: cannot open shared object file: No such file or directory
2023-03-09 22:21:10.957293: I tensorflow/stream_executor/cuda/cudart_stub.cc:29] Ignore above cudart dlerror if you do not have a GPU set up on your machine.
...
spec:
  storageUri: "gs://seldon-models/scv2/examples/mlserver_1.2.4/cifar10/outlier-detector"
  requirements:
    - mlserver
    - alibi-detect
---
...
metadata:
  name: cifar10-drift
spec:
  storageUri: "gs://seldon-models/scv2/examples/mlserver_1.2.4/cifar10/drift-detector"
  requirements:
    - mlserver
    - alibi-detect
  ...
  "versions": [
    {
      ...
      "state": {
        ...
        "lastChangeTimestamp": "2023-03-09T22:21:40.960048511Z",
        "modelsReady": true
      }
    }
  ]
...
```
seldon.default.model.cifar10-drift.outputs	cg55stofh5ss73a44vi0	{"name":"is_drift","datatype":"INT64","shape":["1","1"],"contents":{"int64Contents":["0"]}}
...
```
seldon.default.model.cifar10-drift.outputs	cg55sv8fh5ss73a44vig	{"name":"is_drift","datatype":"INT64","shape":["1","1"],"contents":{"int64Contents":["1"]}}
...
```
<Response [200]>
{'model_name': '', 'outputs': [{'data': [0.000113171176, 1.406766e-05, 2.0854516e-07, 0.9849658, 6.359916e-08, 3.1181237e-06, 0.014892147, 4.5401755e-08, 6.521395e-06, 4.9376104e-06], 'name': 'fc10', 'shape': [1, 10], 'datatype': 'FP32'}, {'data': [1], 'name': 'is_outlier', 'shape': [1, 1], 'datatype': 'INT64'}]}
...
```
seldon.default.model.cifar10.outputs	cg55t50fh5ss73a44vk0	{"modelName":"cifar10_1","modelVersion":"1","outputs":[{"name":"fc10","datatype":"FP32","shape":["1","10"],"contents":{"fp32Contents":[1.45001495e-8,1.2525752e-9,1.6298458e-7,0.11529388,1.7431412e-7,0.0000061856604,0.8846994,6.0739285e-9,7.43792e-8,4.7317337e-9]}}]}
