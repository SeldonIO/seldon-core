...
def NumpyArrayToSeldonRPC(arr,names):
    ...
    fbs.SeldonMessage.SeldonMessageAddProtocol(builder,fbs.SeldonProtocolVersion.SeldonProtocolVersion.V1)
    fbs.SeldonMessage.SeldonMessageAddStatus(builder,status)
    fbs.SeldonMessage.SeldonMessageAddDataType(builder,fbs.Data.Data.DefaultData)
    ...
    fbs.SeldonRPC.SeldonRPCAddMethod(builder,fbs.SeldonMethod.SeldonMethod.PREDICT)
    fbs.SeldonRPC.SeldonRPCAddMessageType(builder,fbs.SeldonPayload.SeldonPayload.SeldonMessage)
...
def SeldonRPCToNumpyArray(data):
    seldon_msg = fbs.SeldonMessage.SeldonMessage.GetRootAsSeldonMessage(data,0)
