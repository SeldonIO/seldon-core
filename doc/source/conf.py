...
latex_documents = [
    (master_doc, 'seldon-core.tex', 'seldon-core Documentation',
...
man_pages = [
    (master_doc, 'seldon-core', 'seldon-core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'seldon-core', 'seldon-core Documentation',
     author, 'seldon-core', 'One line description of project.',
     'Miscellaneous'),
]
