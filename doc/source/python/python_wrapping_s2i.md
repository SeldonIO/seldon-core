...
```bash
s2i usage seldonio/seldon-core-s2i-python3:1.3.0-dev_20201009175340
```
 ...
 * Python 3.6 : seldonio/seldon-core-s2i-python36:1.3.0-dev_20201009175340 seldonio/seldon-core-s2i-python3:1.3.0-dev_20201009175340
...
```bash
s2i build <src-folder> seldonio/seldon-core-s2i-python3:1.3.0-dev_20201009175340 <my-image-name>
```
...
```bash
s2i build https://github.com/seldonio/seldon-core.git --context-dir=wrappers/s2i/python/test/model-template-app seldonio/seldon-core-s2i-python3:1.3.0-dev_20201009175340 seldon-core-template-model
```
...
cd seldon-core
s2i build wrappers/s2i/python/test/model-template-app seldonio/seldon-core-s2i-python3:1.3.0-dev_20201009175340 seldon-core-template-model
```
...
s2i build \
   ...
   <src-folder> \
   seldonio/seldon-core-s2i-python3:1.3.0-dev_20201009175340 \
   <my-image-name>
```
...
```bash
s2i build -i <python-wheel-folder>:/whl <src-folder> seldonio/seldon-core-s2i-python3:1.3.0-dev_20201009175340 <my-image-name>
```
