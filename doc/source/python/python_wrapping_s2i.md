...
```bash
s2i usage seldonio/seldon-core-s2i-python3:1.2.2-dev_20200710140320
```
 ...
 * Python 3.6 : seldonio/seldon-core-s2i-python36:1.2.2-dev_20200710140320 seldonio/seldon-core-s2i-python3:1.2.2-dev_20200710140320
...
```bash
s2i build <src-folder> seldonio/seldon-core-s2i-python3:1.2.2-dev_20200710140320 <my-image-name>
```
...
```bash
s2i build https://github.com/seldonio/seldon-core.git --context-dir=wrappers/s2i/python/test/model-template-app seldonio/seldon-core-s2i-python3:1.2.2-dev_20200710140320 seldon-core-template-model
```
...
cd seldon-core
s2i build wrappers/s2i/python/test/model-template-app seldonio/seldon-core-s2i-python3:1.2.2-dev_20200710140320 seldon-core-template-model
```
...
```bash
s2i build -i <python-wheel-folder>:/whl <src-folder> seldonio/seldon-core-s2i-python3:1.2.2-dev_20200710140320 <my-image-name>
```
