 ...
 * Python 3.6 : seldonio/seldon-core-s2i-python36:1.14.0 seldonio/seldon-core-s2i-python3:1.14.0
...
s2i build \
   ...
   <src-folder> \
   seldonio/seldon-core-s2i-python3:1.14.0 \
   <my-image-name>
```
...
```bash
s2i build -i <python-wheel-folder>:/whl <src-folder> seldonio/seldon-core-s2i-python3:1.14.0 <my-image-name>
```
