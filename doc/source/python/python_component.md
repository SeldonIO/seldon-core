...
After you have created the Component you need to create a Docker image that can be managed by Seldon Core. Follow the odcumentation [here](./python_wrapping.md).
