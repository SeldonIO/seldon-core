...
The image used now is `seldonio/rclone-storage-initializer:1.15.1` which is the same as one used for the non-OpenShift releases (*).
...
```yaml
storageInitializer:
  image: seldonio/rclone-storage-initializer:1.15.1
```
