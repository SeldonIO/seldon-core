...
```console
$ gsutil cp model.joblib gs://seldon-models/v1.10.0/sklearn/iris/model.joblib

[ Saved into gs://seldon-models/v1.10.0/sklearn/iris/model.joblib ]
```
...
spec:
  ...
  - graph:
      ...
      modelUri: gs://seldon-models/v1.10.0/sklearn/iris
      name: classifier
    name: default
    replicas: 1
END
...
```console
s2i build . seldonio/seldon-core-s2i-python3:1.10.0 sklearn_iris:0.1
```
