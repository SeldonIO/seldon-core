...
```console
$ gsutil cp model.joblib gs://seldon-models/v1.18.0-dev/sklearn/iris/model.joblib

[ Saved into gs://seldon-models/v1.18.0-dev/sklearn/iris/model.joblib ]
```
...
```console
s2i build . seldonio/seldon-core-s2i-python3:1.18.0-dev sklearn_iris:0.1
```
