...
```console
$ gsutil cp model.joblib gs://seldon-models/v1.14.1/sklearn/iris/model.joblib

[ Saved into gs://seldon-models/v1.14.1/sklearn/iris/model.joblib ]
```
...
```console
s2i build . seldonio/seldon-core-s2i-python3:1.14.1 sklearn_iris:0.1
```
