...
type InferenceExplainerSpec struct {
	...
	// +optional
	StorageURI string `json:"storageUri,omitempty" protobuf:"bytes,3,opt,name=storageUri"`
	// Resources needed for artifact, cpu, memory etc
	// +optional
	Resources v1.ResourceList `json:"resources,omitempty" protobuf:"bytes,4,rep,name=resources,casttype=ResourceList,castkey=ResourceName"`
	...
	// +optional
	ModelRef string `json:"modelRef,omitempty" protobuf:"bytes,7,opt,name=modelRef"`
}
