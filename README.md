 ...
 * Easy way to containerise ML models using our [pre-packaged inference servers](../docs-gb/servers/overview.md), [custom servers](https://docs.seldon.io/projects/seldon-core/en/latest/servers/custom.html), or [language wrappers](https://docs.seldon.io/projects/seldon-core/en/latest/wrappers/language_wrappers.html).
...
```console
gs://seldon-models/v1.19.0-rc.1/sklearn/iris/model.joblib
```
...
spec:
  ...
  - graph:
      ...
      modelUri: gs://seldon-models/v1.19.0-rc.1/sklearn/iris
      name: classifier
    name: default
    replicas: 1
END
