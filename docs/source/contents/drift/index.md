...
Usually you would run these model in an asynchronous part of a Pipeline, i.e. they are not connected to the output of the Pipeline which defines the sychronous path. For example the CIFAR10 image detection example uses a pipeline as shown below:
