...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', help='Prediction data input path', default='./input.json',
                        type=str)
    parser.add_argument('--output_path', help='Prediction data output path', default='./payload.bin',
                        type=str)
