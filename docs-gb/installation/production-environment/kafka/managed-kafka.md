---
description: Guide to integrating managed Kafka services (Confluent Cloud, Amazon MSK, Azure Event Hub) with Seldon Core 2, including security configurations and authentication setup.
---
