...
| **Envoy***                 | 1.32.2             | 1.32.2             | Required. *It is included as part of the Seldon Core 2 Docker images. You are not required to install it separately but must be aware of the configuration options supported by these versions.*                                                                                                                                                |
| **Rclone***                | 1.68.2             | 1.69.0            | Required. *It is included as part of the Seldon Core 2 Docker images. You are not required to install it separately but must be aware of the configuration options supported by these versions.*                                                                                                                                                |
