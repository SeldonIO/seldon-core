...
Below is the 2nd half of the [seldondeployment\_types.go](../../operator/apis/machinelearning.seldon.io/v1/seldondeployment_types.go)  file which contains the types that are used in the SeldonDeployment YAML files.<br>
