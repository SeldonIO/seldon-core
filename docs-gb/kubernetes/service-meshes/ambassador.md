---
description: >-
  Learn how to integrate Seldon Core 2 with Ambassador for service mesh and
  ingress management, including REST and gRPC endpoint configuration.
---
...
_**Currently not working due to this**_ [_**issue**_](https://github.com/emissary-ingress/emissary/issues/4062)
