---
description: >-
  Explore the enterprise MLOps capabilities of Core 2 for production ML
  deployment, featuring model serving, pipeline orchestration, and intelligent
  resource management for scalable ML systems.
---
...
![Data-centric pipeline](.gitbook/assets/pipeline-intro.png)
...
![Example: Serving multiple model types across inference servers](.gitbook/assets/models-servers.png)
...
* [Install Seldon Core 2](getting-started/)
* Explore our [Tutorials](examples/)
