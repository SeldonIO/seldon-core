...
curl 0.0.0.0:2222 -d '{"data":{"names":["a"],"ndarray":["test1","test2"]}}' -H "Content-Type: application/json" -H "Ce-Type: io.seldon.serving.inference.request" -H "Seldon-Puid: 3c" -H "Ce-Inferenceservicename: seldon-model" \
