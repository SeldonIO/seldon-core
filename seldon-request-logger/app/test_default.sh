...
#text in ndarray - based on example in deploy samples
curl 0.0.0.0:2222 -d '{"data": {"names": ["Text review"],"ndarray": ["this film has bad actors"]}}' -H "Ce-Inferenceservicename: textndarray" -H "Content-Type: application/json" -H "Ce-Type: io.seldon.serving.inference.request" -H "Ce-Requestid: 6f"
curl 0.0.0.0:2222 -d '{"data":{"names":["t0","t1"],"ndarray":[0.5,0.5]}}' -H "Ce-Inferenceservicename: textndarray" -H "Content-Type: application/json" -H "Ce-Type: io.seldon.serving.inference.response" -H "Ce-Requestid: 6f"
