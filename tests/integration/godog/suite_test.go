...
func InitializeScenario(ctx *godog.ScenarioContext) {
	...
	// Before prep the state of world however clients need to be long live
	...
	// bringing back deployments to starting state and deleting models and servers core 2
	...
	//todo load other steps such as pipeline steps etc
}
