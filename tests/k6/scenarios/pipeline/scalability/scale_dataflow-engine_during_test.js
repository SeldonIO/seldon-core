...
const inputModelName1 = 'romeo-input-1'
const inputModelName2 = 'romeo-input-2'
const inputModelType = 'synth'
const outputModelType = 'synth'
const outputModelName = 'romeo-combiner'
const pipelineName = 'romeo-pipeline';
const serverName = "romeo-mlserver"
...
// During the test, dataflow-engine
// will be scaled up multiple times,
// amount of times governed by runScaleDataFlowEngineOpTimes
