...
export function setup() {
    ...
    if (updated !== seldonOpExecStatus.OK) {
        throw "Failed to load server"
    }

    const pipeline = generateMultiModelPipelineYaml(1, modelType, modelName, modelParams, config.modelName, modelServerReplicas, 1)
