...
| explainer.image_v2 | string | `"seldonio/mlserver:1.4.0.rc2-alibi-explain"` |  |
...
| predictor_servers.HUGGINGFACE_SERVER.protocols.v2.defaultImageVersion | string | `"1.4.0.rc2-huggingface"` |  |
...
| predictor_servers.MLFLOW_SERVER.protocols.v2.defaultImageVersion | string | `"1.4.0.rc2-mlflow"` |  |
...
| predictor_servers.SKLEARN_SERVER.protocols.v2.defaultImageVersion | string | `"1.4.0.rc2-sklearn"` |  |
| predictor_servers.SKLEARN_SERVER.protocols.v2.image | string | `"seldonio/mlserver"` |  |
| predictor_servers.TEMPO_SERVER.protocols.v2.defaultImageVersion | string | `"1.4.0.rc2-slim"` |  |
...
| predictor_servers.XGBOOST_SERVER.protocols.v2.defaultImageVersion | string | `"1.4.0.rc2-xgboost"` |  |
