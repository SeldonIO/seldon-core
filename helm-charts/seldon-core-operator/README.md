...
![Version: 1.17.0](https://img.shields.io/static/v1?label=Version&message=1.17.0&color=informational&style=flat-square)
...
| executor.image.tag | string | `"1.17.0"` |  |
...
| explainer.image | string | `"seldonio/alibiexplainer:1.17.0"` |  |
...
| predictor_servers.MLFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.17.0"` |  |
...
| predictor_servers.SKLEARN_SERVER.protocols.seldon.defaultImageVersion | string | `"1.17.0"` |  |
...
| predictor_servers.TENSORFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.17.0"` |  |
...
| predictor_servers.XGBOOST_SERVER.protocols.seldon.defaultImageVersion | string | `"1.17.0"` |  |
...
| storageInitializer.image | string | `"seldonio/rclone-storage-initializer:1.17.0"` |  |
