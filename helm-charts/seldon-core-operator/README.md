...
| predictor_servers.SKLEARN_SERVER.protocols.kfserving.defaultImageVersion | string | `"0.4.0"` |  |
...
| predictor_servers.TEMPO_SERVER.protocols.kfserving.defaultImageVersion | string | `"0.4.0"` |  |
...
| predictor_servers.XGBOOST_SERVER.protocols.kfserving.defaultImageVersion | string | `"0.4.0"` |  |
