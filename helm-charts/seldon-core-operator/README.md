...
![Version: 1.9.1](https://img.shields.io/static/v1?label=Version&message=1.9.1&color=informational&style=flat-square)
...
| executor.image.tag | string | `"1.9.1"` |  |
...
| explainer.image | string | `"seldonio/alibiexplainer:1.9.1"` |  |
...
| predictor_servers.MLFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.9.1"` |  |
...
| predictor_servers.SKLEARN_SERVER.protocols.seldon.defaultImageVersion | string | `"1.9.1"` |  |
...
| predictor_servers.TENSORFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.9.1"` |  |
...
| predictor_servers.XGBOOST_SERVER.protocols.seldon.defaultImageVersion | string | `"1.9.1"` |  |
...
| storageInitializer.image | string | `"seldonio/rclone-storage-initializer:1.9.1"` |  |
