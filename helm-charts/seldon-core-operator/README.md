...
| executor.image.tag | string | `"1.13.1"` |  |
...
| explainer.image | string | `"seldonio/alibiexplainer:1.13.1"` |  |
...
| predictor_servers.MLFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.13.1"` |  |
...
| predictor_servers.SKLEARN_SERVER.protocols.seldon.defaultImageVersion | string | `"1.13.1"` |  |
...
| predictor_servers.TENSORFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.13.1"` |  |
...
| predictor_servers.XGBOOST_SERVER.protocols.seldon.defaultImageVersion | string | `"1.13.1"` |  |
...
| storageInitializer.image | string | `"seldonio/rclone-storage-initializer:1.13.1"` |  |
