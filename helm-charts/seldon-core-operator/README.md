...
| explainer.image_v2 | string | `"seldonio/mlserver:1.3.2.rc3-alibi-explain"` |  |
...
| predictor_servers.HUGGINGFACE_SERVER.protocols.v2.defaultImageVersion | string | `"1.3.2.rc3-huggingface"` |  |
...
| predictor_servers.MLFLOW_SERVER.protocols.v2.defaultImageVersion | string | `"1.3.2.rc3-mlflow"` |  |
...
| predictor_servers.SKLEARN_SERVER.protocols.v2.defaultImageVersion | string | `"1.3.2.rc3-sklearn"` |  |
| predictor_servers.SKLEARN_SERVER.protocols.v2.image | string | `"seldonio/mlserver"` |  |
| predictor_servers.TEMPO_SERVER.protocols.v2.defaultImageVersion | string | `"1.3.2.rc3-slim"` |  |
...
| predictor_servers.XGBOOST_SERVER.protocols.v2.defaultImageVersion | string | `"1.3.2.rc3-xgboost"` |  |
