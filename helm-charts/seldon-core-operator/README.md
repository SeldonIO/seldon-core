...
| executor.image.tag | string | `"1.6.0"` |  |
...
| explainer.image | string | `"seldonio/alibiexplainer:1.6.0"` |  |
...
| predictor_servers.MLFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.6.0"` |  |
...
| predictor_servers.SKLEARN_SERVER.protocols.seldon.defaultImageVersion | string | `"1.6.0"` |  |
| predictor_servers.SKLEARN_SERVER.protocols.seldon.image | string | `"seldonio/sklearnserver"` |  |
| predictor_servers.TENSORFLOW_SERVER.protocols.seldon.defaultImageVersion | string | `"1.6.0"` |  |
...
| predictor_servers.XGBOOST_SERVER.protocols.seldon.defaultImageVersion | string | `"1.6.0"` |  |
