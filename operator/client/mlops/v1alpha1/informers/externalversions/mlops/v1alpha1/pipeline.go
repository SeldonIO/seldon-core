...
import (
	...
	versioned "github.com/seldonio/seldon-core/operatorv2/client/mlops/v1alpha1/clientset/versioned"
	internalinterfaces "github.com/seldonio/seldon-core/operatorv2/client/mlops/v1alpha1/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/seldonio/seldon-core/operatorv2/client/mlops/v1alpha1/listers/mlops/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MlopsV1alpha1().Pipelines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MlopsV1alpha1().Pipelines(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mlopsv1alpha1.Pipeline{}, f.defaultInformer)
}
