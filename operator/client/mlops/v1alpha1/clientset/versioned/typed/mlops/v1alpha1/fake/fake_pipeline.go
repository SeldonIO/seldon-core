...
var pipelinesResource = schema.GroupVersionResource{Group: "mlops", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "mlops", Version: "v1alpha1", Kind: "Pipeline"}
