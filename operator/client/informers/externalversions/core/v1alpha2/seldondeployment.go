...
import (
	...
	apiv1alpha2 "github.com/seldonio/seldon-core/operator/api/v1alpha2"
	versioned "github.com/seldonio/seldon-core/operator/client/clientset/versioned"
	internalinterfaces "github.com/seldonio/seldon-core/operator/client/informers/externalversions/internalinterfaces"
	v1alpha2 "github.com/seldonio/seldon-core/operator/client/listers/core/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha2().SeldonDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha2().SeldonDeployments(namespace).Watch(options)
			},
		},
		&apiv1alpha2.SeldonDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *seldonDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiv1alpha2.SeldonDeployment{}, f.defaultInformer)
}
