...
import (
	...
	versioned "github.com/seldonio/seldon-core/operator/client/machinelearning/v1/clientset/versioned"
	internalinterfaces "github.com/seldonio/seldon-core/operator/client/machinelearning/v1/informers/externalversions/internalinterfaces"
	v1 "github.com/seldonio/seldon-core/operator/client/machinelearning/v1/listers/machinelearning/v1"
...
func (f *seldonDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinelearningv1.SeldonDeployment{}, f.defaultInformer)
}
