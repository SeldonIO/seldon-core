...
import (
	...
	versioned "github.com/seldonio/seldon-core/operator/client/machinelearning/v1alpha3/clientset/versioned"
	internalinterfaces "github.com/seldonio/seldon-core/operator/client/machinelearning/v1alpha3/informers/externalversions/internalinterfaces"
	v1alpha3 "github.com/seldonio/seldon-core/operator/client/machinelearning/v1alpha3/listers/machinelearning/v1alpha3"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MachinelearningV1alpha3().SeldonDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MachinelearningV1alpha3().SeldonDeployments(namespace).Watch(options)
			},
		},
		&machinelearningv1alpha3.SeldonDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *seldonDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinelearningv1alpha3.SeldonDeployment{}, f.defaultInformer)
}
