...
var seldondeploymentsResource = schema.GroupVersionResource{Group: "machinelearning", Version: "v1alpha3", Resource: "seldondeployments"}

var seldondeploymentsKind = schema.GroupVersionKind{Group: "machinelearning", Version: "v1alpha3", Kind: "SeldonDeployment"}
...
func (c *FakeSeldonDeployments) Get(name string, options v1.GetOptions) (result *v1alpha3.SeldonDeployment, err error) {
	obj, err := c.Fake.
...
func (c *FakeSeldonDeployments) List(opts v1.ListOptions) (result *v1alpha3.SeldonDeploymentList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSeldonDeployments) Create(seldonDeployment *v1alpha3.SeldonDeployment) (result *v1alpha3.SeldonDeployment, err error) {
	obj, err := c.Fake.
...
func (c *FakeSeldonDeployments) Update(seldonDeployment *v1alpha3.SeldonDeployment) (result *v1alpha3.SeldonDeployment, err error) {
	obj, err := c.Fake.
...
func (c *FakeSeldonDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha3.SeldonDeployment, err error) {
	obj, err := c.Fake.
