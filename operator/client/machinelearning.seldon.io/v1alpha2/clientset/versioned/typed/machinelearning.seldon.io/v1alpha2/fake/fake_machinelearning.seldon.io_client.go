...
import (
	v1alpha2 "github.com/seldonio/seldon-core/operator/client/machinelearning.seldon.io/v1alpha2/clientset/versioned/typed/machinelearning.seldon.io/v1alpha2"
