...
import (
	...
	machinelearningseldoniov1alpha2 "github.com/seldonio/seldon-core/operator/apis/machinelearning.seldon.io/v1alpha2"
	versioned "github.com/seldonio/seldon-core/operator/client/machinelearning.seldon.io/v1alpha2/clientset/versioned"
	...
	v1alpha2 "github.com/seldonio/seldon-core/operator/client/machinelearning.seldon.io/v1alpha2/listers/machinelearning.seldon.io/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MachinelearningV1alpha2().SeldonDeployments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MachinelearningV1alpha2().SeldonDeployments(namespace).Watch(context.TODO(), options)
			},
		},
		&machinelearningseldoniov1alpha2.SeldonDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *seldonDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinelearningseldoniov1alpha2.SeldonDeployment{}, f.defaultInformer)
}
