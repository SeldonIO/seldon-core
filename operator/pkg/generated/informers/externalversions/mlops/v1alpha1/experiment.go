...
type ExperimentInformer interface {
	...
	Lister() mlopsv1alpha1.ExperimentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MlopsV1alpha1().Experiments(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MlopsV1alpha1().Experiments(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MlopsV1alpha1().Experiments(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MlopsV1alpha1().Experiments(namespace).Watch(ctx, options)
			},
		},
		&apismlopsv1alpha1.Experiment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *experimentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismlopsv1alpha1.Experiment{}, f.defaultInformer)
}

func (f *experimentInformer) Lister() mlopsv1alpha1.ExperimentLister {
	return mlopsv1alpha1.NewExperimentLister(f.Informer().GetIndexer())
}
