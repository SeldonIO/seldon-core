...
"${BINDIR}/client-gen" -v 9 --input-base ${PKG_BASE}/apis --clientset-name versioned -i ./apis/machinelearning/v1alpha2/ --input machinelearning/v1alpha2 --output-package ${PKG_BASE}/client/clientset --go-header-file hack/boilerplate.go.txt -o ${FAKE_GOPATH}/src

"${BINDIR}/lister-gen" -v 5 -i ${PKG_BASE}/apis/machinelearning/v1alpha2 --output-package ${PKG_BASE}/client/listers --go-header-file hack/boilerplate.go.txt -o ${FAKE_GOPATH}/src

"${BINDIR}/informer-gen" -v 5 \
     -i ${PKG_BASE}/apis/machinelearning/v1alpha2 \
