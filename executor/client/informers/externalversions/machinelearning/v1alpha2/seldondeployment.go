...
import (
	...
	machinelearningv1alpha2 "github.com/seldonio/seldon-core/executor/api/machinelearning/v1alpha2"
	...
	v1alpha2 "github.com/seldonio/seldon-core/executor/client/listers/machinelearning/v1alpha2"
...
func (f *seldonDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinelearningv1alpha2.SeldonDeployment{}, f.defaultInformer)
}
