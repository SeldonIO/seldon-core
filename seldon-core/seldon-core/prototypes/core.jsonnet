...
// @optionalParam apifeImage string seldonio/apife:0.1.8-ISTIO-SNAPSHOT Default image for API Front End
// @optionalParam apifeServiceType string NodePort API Front End Service Type
// @optionalParam operatorImage string seldonio/cluster-manager:0.1.8-ISTIO-SNAPSHOT Seldon cluster manager image version
...
// @optionalParam engineImage string seldonio/engine:0.1.8-ISTIO-SNAPSHOT Seldon engine image version
