...
helm template --set ambassador.enabled=true --set single_namespace=true --set ambassador.env.AMBASSADOR_SINGLE_NAMESPACE=true seldon-core-release-0.2/helm-charts/seldon-core > template_0.2_single_namespace.yaml
helm template --set ambassador.enabled=true --set single_namespace=false --set ambassador.rbac.namespaced=false seldon-core-release-0.2/helm-charts/seldon-core > template_0.2_cluster_wide.yaml
