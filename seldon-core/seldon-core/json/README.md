...
helm template --set ambassador.enabled=true --set single_namespace=false --set ambassador.rbac.namespaced=false --set ambassador.env.AMBASSADOR_SINGLE_NAMESPACE=false seldon-core-release-0.2/helm-charts/seldon-core > template_0.2_cluster_wide.yaml
